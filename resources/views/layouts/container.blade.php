                ...
                <div class="app-brand demo">
                    <a href="{{ route('home') }}" class="app-brand-link d-flex align-items-center">
                        <img src="{{ asset('assets/img/logo.png') }}" alt="CarDeal Logo" 
                            class="app-brand-logo" style="height: 50px; width: auto; object-fit: contain;">
                        <span class="app-brand-text demo menu-text fw-bolder ms-2 text-uppercase">CarDeal</span>
                    </a>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        @if(isset($myProfile) && $myProfile->img_path)
    <img src="{{ asset('users/profile/' . $myProfile->img_path) }}" alt="profile" class="w-px-40 h-auto rounded-circle img-fluid" />
@else
...
@endif
                ...
                <div class="content-wrapper">
                  ...
                  <!-- Footer -->
<footer class="card-footer text-center bg-dark text-white py-3">
    <p class="mb-0">&copy; 2025 CarDeal Capstone Project. All rights reserved.</p>
</footer>
